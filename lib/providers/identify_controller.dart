...
import 'package:playmusic/components/identied_songinfo.dart';
...
import 'package:playmusic/services/lyrics.dart';
// import 'package:playmusic/services/secrets.dart';
  ...
  void init() async {
    arc
      ..init(
        ...
        accessKey: "1PFCKwYzrdV90Gb5",
        accessSecret: "dVZQb5TRysnUDHTz4LQdb4IKejaExgD3",
        setLog: true,
      )
